...
class CrudPage extends Component
{
    ...
    protected function modules(): array
    {
        ...
        return [
            ...
            'expenses' => ['model' => Expense::class, 'title' => 'expenses.expenses', 'creator' => true, 'search' => ['title'], 'with' => ['expenseCategory'], 'fields' => ['expense_category_id' => ['label' => 'expenses.expense_category', 'type' => 'select', 'options' => 'expense_categories', 'rules' => ['required', 'exists:expense_categories,id']], 'title' => ['label' => 'expenses.title', 'rules' => ['required', 'string']], 'amount' => ['label' => 'common.amount', 'type' => 'number', 'rules' => ['required', 'numeric', 'min:0']], 'expense_date' => ['label' => 'expenses.expense_date', 'type' => 'datetime-local', 'rules' => ['required', 'date']], 'notes' => ['label' => 'common.notes', 'type' => 'textarea']]],
