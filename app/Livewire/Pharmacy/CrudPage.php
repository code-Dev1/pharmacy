...
class CrudPage extends Component
{
    ...
    protected function modules(): array
    {
        ...
        return [
            ...
            'suppliers' => ['model' => Supplier::class, 'title' => 'suppliers.suppliers', 'search' => ['name', 'phone', 'email'], 'with' => ['purchases'], 'fields' => ['name' => ['label' => 'common.name', 'rules' => ['required', 'string']], 'phone' => ['label' => 'common.phone'], 'email' => ['label' => 'common.email', 'type' => 'email'], 'contact_person' => ['label' => 'suppliers.contact_person'], 'address' => ['label' => 'common.address', 'type' => 'textarea', 'col_span' => 'md:col-span-2'], 'notes' => ['label' => 'common.notes', 'type' => 'textarea', 'col_span' => 'md:col-span-2'], 'is_active' => ['label' => 'common.status', 'type' => 'checkbox', 'default' => true]]],
            'customers' => ['model' => Customer::class, 'title' => 'customers.customers', 'search' => ['name', 'phone'], 'with' => ['sales'], 'fields' => ['name' => ['label' => 'common.name', 'rules' => ['required', 'string']], 'phone' => ['label' => 'common.phone'], 'address' => ['label' => 'common.address', 'type' => 'textarea', 'col_span' => 'md:col-span-2'], 'notes' => ['label' => 'common.notes', 'type' => 'textarea', 'col_span' => 'md:col-span-2']]],
