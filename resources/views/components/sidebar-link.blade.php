...
<a href="{{ $href }}" wire:navigate {{ $attributes->class([
    ...
    'bg-white text-emerald-700 shadow-sm ring-1 ring-emerald-500/20 dark:bg-white/10 dark:text-emerald-300' => $active,
    'text-slate-600 hover:bg-slate-100 hover:text-slate-950 dark:text-slate-300 dark:hover:bg-white/5 dark:hover:text-white' => ! $active,
]) }}>
