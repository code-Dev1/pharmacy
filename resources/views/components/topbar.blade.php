...
<header class="sticky top-0 z-30 border-b border-white/70 bg-white/75 backdrop-blur-2xl dark:border-white/10 dark:bg-slate-950/72">
    <div class="flex min-h-16 items-center justify-between gap-4 px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-1 items-center justify-end gap-3">
            <label class="hidden w-full max-w-md items-center gap-2 rounded-2xl border border-slate-200 bg-white/80 px-3 py-2 text-slate-500 shadow-sm dark:border-white/10 dark:bg-white/5 md:flex">
            ...
            <div x-data="{ open: false }" class="relative">
                <button @click="open = !open" class="flex items-center gap-2 rounded-2xl border border-slate-200 bg-white px-3 py-2 text-sm font-medium text-slate-700 shadow-sm transition hover:-translate-y-0.5 hover:bg-slate-50 dark:border-white/10 dark:bg-white/5 dark:text-slate-200 dark:hover:bg-white/10">
                ...
                <div x-show="open" x-transition @click.outside="open = false" class="absolute end-0 mt-2 w-56 overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-xl shadow-slate-900/10 dark:border-white/10 dark:bg-slate-900">
